...
def criar_df_out(df_router_filtrado):
    ...
    df_out_d2 = df_router_filtrado[(df_router_filtrado['Tipo de Servico']=='OUT') & (df_router_filtrado['Data Execucao']==data_roteiro) & 
                                (df_router_filtrado['Horario Voo']<=time(4,0)) & (df_router_filtrado['Horario Apresentacao']<=time(4,0))].reset_index(drop=True)
...
def criar_df_in(df_router_filtrado):
    ...
    df_in_d2 = df_router_filtrado[(df_router_filtrado['Tipo de Servico']=='IN') & (df_router_filtrado['Data Execucao']==data_roteiro) & 
                                  (df_router_filtrado['Horario Voo']<=time(4,0)) & (df_router_filtrado['Horario Apresentacao']<=time(4,0))].reset_index(drop=True)
